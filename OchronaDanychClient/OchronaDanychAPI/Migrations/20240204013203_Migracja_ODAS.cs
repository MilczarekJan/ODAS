        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Combo1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Combo2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Combo3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Combo4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Combo5 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Choice = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Combinations", x => x.Email);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoginAttempts", x => x.UserEmail);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Email = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DocumentNumber = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    DocumentIv = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    DocumentKey = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Username = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PasswordHash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    PasswordSalt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo1Hash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo1Salt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo2Hash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo2Salt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo3Hash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo3Salt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo4Hash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo4Salt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo5Hash = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    Combo5Salt = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
